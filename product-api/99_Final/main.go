...
import (
	...
	"github.com/PacktPublishing/Building-Microservices-with-Go-Second-Edition/product-api/99_Final/handlers"
...
func createHandlers(v *data.Validation, db *data.DB, l hclog.Logger) http.Handler {
