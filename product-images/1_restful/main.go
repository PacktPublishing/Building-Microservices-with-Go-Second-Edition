...
import (
	...
	"github.com/PacktPublishing/Building-Microservices-with-Go-Second-Edition/product-images/1_restful/handlers"
...
func main() {
	...
	postRouter.HandleFunc("/{id:[0-9]+}/{filename:[a-zA-Z]+\\.[a-z0-9]{3}}", fh.SaveFileREST)
